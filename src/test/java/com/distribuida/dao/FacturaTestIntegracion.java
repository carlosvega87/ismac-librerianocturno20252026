...
System.out.println(factura);
    ...
    public void testFacturaUpdate(){
        ...
        Optional<Factura> factura=facturaRepository.findById(89);
    ...
    public void testFacturaDelete(){
        if (facturaRepository.existsById(89)){
            facturaRepository.deleteById(89);
        }
        assertFalse(facturaRepository.existsById(89));
    }
